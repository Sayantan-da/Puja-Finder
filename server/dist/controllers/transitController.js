...
exports.getTrafficAndParking = exports.getSchedules = exports.voteParking = exports.getPandalTransit = void 0;
const mockTransitData_1 = require("../data/mockTransitData");
// In-memory store of parking spots for crowdsourced voting mutations
const parkingStore = new Map(mockTransitData_1.mockParkingSpots.map((spot) => [spot.parkingSpotId, { ...spot }]));
/**
 ...
 */
const getPandalTransit = async (req, res) => {
    try {
        ...
        const transitInfo = mockTransitData_1.mockPandalTransitMap[id];
        if (!transitInfo) {
...
exports.voteParking = voteParking;
/**
...
const getSchedules = async (req, res) => {
    try {
        ...
        let metro = [...mockTransitData_1.mockMetroTimetables];
        let buses = [...mockTransitData_1.mockBusRoutes];
        if (day) {
        ...
        if (search && search.trim().length > 0) {
            ...
            buses = buses.filter((b) => b.routeNumber.toLowerCase().includes(q) ||
 ...
 */
const getTrafficAndParking = async (_req, res) => {
    try {
        const spots = Array.from(parkingStore.values());
        res.status(200).json({
            success: true,
            data: {
                restrictions: mockTransitData_1.mockTrafficRestrictions,
                parkingSpots: spots,
            },
        });
    }
...
exports.getTrafficAndParking = getTrafficAndParking;
